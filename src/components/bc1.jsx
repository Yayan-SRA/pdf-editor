    ...
    <div>
      ...
      <div className="dropdown">
        ...
        <ul className="dropdown-menu">
          ...
          <li><a className="dropdown-item" onClick={() => setVariant('CustomWithQuery')} href="#">Custom With Query</a></li>
        </ul>
      </div>
      {variant && (
        <>
        ...
        <button className="btn btn-danger m-1" onClick={deleteSelectedObjects}><i className="fa-solid fa-trash-can"></i></button>
        </>
      )}
    </div>
  );
