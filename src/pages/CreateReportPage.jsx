...
function CreateReportPage() {
  ...
  const { reportId } = useParams(); // Use the reportId from the URL
    ...
    <div className="d-flex flex-column h-100">
      <div className="d-flex flex-grow-1">
        <div className="sidebar bg-light p-3 border-right">
          ...
          <br />
          <button className='btn btn-primary mt-2' onClick={toggleTextSidebar}><p style={{ margin:0 }}><b>T<small>t</small></b></p></button>
          {showTextSidebar && (
